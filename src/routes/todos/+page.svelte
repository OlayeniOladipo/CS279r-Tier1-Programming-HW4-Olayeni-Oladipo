...
<div class="todos">
	...
	<!-- This is a way to invoke an action from another page
     outside of page.server.js. action="/todos?/add" points to the 
	 action. todos? is a query parameter before the action.
	 POST method is for actions. -->
	<form
		class="new"
		action="/todos?/add"
		method="post"
	...
	<!-- Forloop that goes through each todo in data and creates an html element. -->
